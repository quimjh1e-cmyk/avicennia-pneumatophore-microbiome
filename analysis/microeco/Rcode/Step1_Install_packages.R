...
#ANCOMBC issue
# 1. Remove CVXR completely
remove.packages("CVXR")

# 2. Restart R session (Ctrl+Shift+F10 in RStudio)

# 3. Verify it's gone
library(CVXR)  # should give an error saying package not found

# 4. Now install the compatible version
remotes::install_version("CVXR", version = "1.0-14")
