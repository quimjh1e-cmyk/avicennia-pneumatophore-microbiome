...
# load data
input_path <- "Output/1.Amplicon/Stage2_amplicon_microtable/amplicon_16S_microtable_raw.RData"
...
tmp <- trans_rarefy$new(amplicon_16S_microtable_raw, alphadiv = c("Shannon"), depth = c(0, 10, 50, 500, 1000, 2000, 4000, 6000, 10000, 15000, 20000, 25000, 30000))
...
# PD = TRUE calculates Faith's phylogenetic diversity (requires the picante package and a phylogenetic tree in the microtable object)
tmp_microtable$cal_alphadiv(PD = TRUE)
